...
public class Empleado
{
    ...
    private double adicional(){
        if(antiguedad() < 2){
            return (this.getSueldoBasico() / 100 * 2) + this.getSueldoBasico();
        }else if(antiguedad() >= 2 && antiguedad () < 10){
            return (this.getSueldoBasico() / 100 * 4) + this.getSueldoBasico();
        }
        else if(antiguedad() > 10){
            return (this.getSueldoBasico() / 100 * 6) + this.getSueldoBasico();
        }
 ...
 /**
  ...
  {
    Empleado empleado = new Empleado(2323412, "Vivero", "Sergio", 500000, 2018);
    empleado.mostrar();
